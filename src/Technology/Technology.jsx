...
// //   useEffect(() => {
// //   const apiUrl = 'https://atla-knots-solution-admin-1.onrender.com/api/technology/category';
// //   fetch(apiUrl)    .then(response => response.json())
// //     .then(data => {
// //       console.log('Fetched Technology News:', data);
...
// //     const apiUrl = 'https://atla-knots-solution-admin-1.onrender.com/api/technology/product';
// //     fetch(apiUrl)      .then(response => response.json())
// //       .then(data => {
// //         console.log('Fetched Technology News:', data);
// //         // You can set the fetched data to state here if needed
...
//       try {
//         const response = await fetch("https://atla-knots-solution-admin-1.onrender.com/api/technology/category", {
//           method: "GET",
//           headers: {
...
//           `https://atla-knots-solution-admin-1.onrender.com/api/technology/product?categoryId=${selectedCategory._id}`,
//           {
//             method: "GET",
//             headers: {
//               "Content-Type": "application/json",
...
//                   year: "numeric",
//                 }),
//           category: item.category?.name || selectedCategory.name || "General",
...
//               <p className="text-gray-400 text-lg">Please select a category to view products</p>
//             </div>
//           )}

//           {/* Empty State - No Products */}
//           {!loading && !error && selectedCategory && newsItems.length === 0 && (
//             <div className="text-center py-20">
