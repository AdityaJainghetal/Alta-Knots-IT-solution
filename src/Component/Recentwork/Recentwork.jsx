...
// import img1 from '../Mobile/img/recent3.jpg';
// import img2 from '../Mobile/img/recent4.jpg';
// import img3 from '../Mobile/img/recent5.jpg';
...
// // ────────────────────────────────────────────────
// // PORTFOLIO DATA (fixed image references)
// // ────────────────────────────────────────────────

// const portfolioItems = [
//   { id: '1561', title: 'Parineek',     categories: ['Consultancy', 'Global Business', 'Industrial', 'UI/UX'],     image: img1 },
//   { id: '1554', title: 'Nova Quinta',  categories: ['Consultancy', 'Corporate', 'Global Business', 'UI/UX'],       image: img2 },
//   { id: '1541', title: 'FirstMeridian',categories: ['Consultancy', 'Resourcing'],                                  image: img3 },
//   { id: '1533', title: 'AIOne Health', categories: ['Consultancy', 'Corporate', 'Medical', 'SAAS', 'Software', 'UI/UX'], image: img4 },
//   { id: '1522', title: 'Clanbridge',   categories: ['Hospitality', 'Lifestyle', 'Real Estate', 'UI/UX'],           image: img5 },
//   { id: '1477', title: 'Acutok',       categories: ['Consultancy', 'SAAS', 'Software', 'UI/UX'],                   image: img6 },
//   { id: '1473', title: 'MentorPOS',    categories: ['Consultancy', 'SAAS', 'Software', 'UI/UX'],                   image: img8 },
//   { id: '1456', title: 'Alankaram',    categories: ['Ecommerce', 'Furniture', 'Lifestyle'],                        image: img7 },
//   { id: '1517', title: 'Aaalay',       categories: ['Consultancy', 'SAAS', 'Software', 'UI/UX'],                   image: img9 },
// ];
...
//       {/* Background Effects */}
//       <div className="absolute inset-0 z-0" style={{ height: 'calc(100vh + 3000px)' }}>
...
//         {/* Masonry Grid */}
//         <div className="columns-1 sm:columns-2 lg:columns-3 lg:gap-0">
...
//                   bg-gray-900/40 backdrop-blur-md border border-gray-800/60
//                   shadow-xl shadow-black/40
//                   transition-all duration-500
//                   hover:shadow-2xl hover:shadow-red-900/40 hover:-translate-y-2
//                 "
//               >
//                 <img
//                   src={item.image}
//                   alt={item.title}
//                   className="
//                     w-full h-auto aspect-[4/5] object-cover
...
//                 {/* Hover Overlay */}
//                 <div className="
//                   absolute inset-0 bg-gradient-to-t from-black/90 via-black/70 to-transparent
...
//                     {item.title}
//                   </h3>
//                   <p className="text-sm sm:text-base font-medium uppercase tracking-wider text-gray-300">
...
//             href="/contact"
//             className="
//               inline-flex items-center gap-3 px-8 sm:px-10 py-4 sm:py-5
...
// ────────────────────────────────────────────────
// MAIN COMPONENT – radius removed from cards & images
// ────────────────────────────────────────────────
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-16 md:py-20 lg:py-24">
        ...
        >
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed"
          >
            Delivering exceptional digital solutions across industries — from
        ...
        {/* Masonry Grid – NO rounded corners */}
