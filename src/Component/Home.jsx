...
//   <h3 className="text-4xl md:text-5xl font-bold mb-6 text-red-400 text-center tracking-tight">
//     2. Business Process Outsourcing (BPO) Services
//   </h3>

//   <p className="text-lg md:text-xl text-gray-300 mb-12 text-center max-w-3xl mx-auto leading-relaxed">
//     Streamline operations and enhance customer engagement with reliable, scalable support solutions.
//   </p>
...
//       initial="rest"
//       whileHover="hover"
//       className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full transition-all duration-300"
//     >
...
//         <li>• Inbound & outbound voice support</li>
//         <li>• Real-time live chat assistance</li>
//         <li>• Structured email handling & ticketing</li>
//       </ul>
//     </motion.div>
...
//       </h4>
//       <ul className="text-gray-300 space-y-3 text-sm md:text-base w-full max-w-xs">
//         <li>• Detailed product descriptions, tags & keywords</li>
//         <li>• Data validation, cleaning & error correction</li>
//         <li>• Category mapping & attribute enrichment</li>
//       </ul>
//     </motion.div>
...
//       initial="rest"
//       whileHover="hover"
//       className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full transition-all duration-300 lg:col-span-1 sm:col-span-2"
//     >
...
//         Regular call/chat audits, SOP & SLA compliance checking, detailed feedback, agent coaching, and continuous process improvement programs.
//       </p>
//     </motion.div>
//   </div>
// </div>
